...
class ArucoNode(Node):
    ...
    def aruco_callback(self, msg):
        ...
        try:
            ...
            aruco_map_pose.pose.position.x = transform.transform.translation.y - aruco_position.x - camera_offset[0] + base_offset[0] + self.offset_x
            aruco_map_pose.pose.position.y = transform.transform.translation.x - aruco_position.z + camera_offset[1] + base_offset[1] - self.offset_y
